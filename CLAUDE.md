...
- `src/data/phraseContent.js` — speech-therapy vocab: 221 core words (frequency tiers / categories), `PHRASES` (2-/3-word banks), `imageKeyFor`/`WORD_ALIAS` (image reuse), readiness helpers.

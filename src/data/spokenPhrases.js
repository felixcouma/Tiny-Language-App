...
import { SCENE_LINES, SCENE_PROMPTS, SCENE_PRAISE } from './gameScenes.js'
...
export function spokenTexts() {
  ...
  SCENE_PRAISE.forEach(add) // praise word ("Cow!") for every pool item — any can be the target now
  PRAISE.forEach(add)

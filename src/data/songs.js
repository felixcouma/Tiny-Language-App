...
export const SONGS = [
  { id: 'the-alphabet-song',                 title: 'The Alphabet Song',                 tag: 'Letters',  grad: 'linear-gradient(135deg, #7C4DFF 0%, #B388FF 100%)' },
  { id: 'head-shoulders-knees-and-toes',     title: 'Head, Shoulders, Knees, and Toes',  tag: 'My body',  grad: 'linear-gradient(135deg, #00B8A9 0%, #5FE0C8 100%)' },
  { id: 'bingo',                             title: 'Bingo',                             tag: 'Animals',  grad: 'linear-gradient(135deg, #FF8C00 0%, #FFB347 100%)' },
  { id: 'twinkle-twinkle-little-star',       title: 'Twinkle, Twinkle, Little Star',     tag: 'Night',    grad: 'linear-gradient(135deg, #3A6EA5 0%, #6FA8DC 100%)' },
  ...
  { id: 'are-you-sleeping',                  title: 'Are You Sleeping?',                 tag: 'Lullaby',  grad: 'linear-gradient(135deg, #455A87 0%, #7E8FC0 100%)' },
  { id: 'over-the-river-and-through-the-woods', title: 'Over the River and Through the Woods', tag: 'Seasons', grad: 'linear-gradient(135deg, #2E8B57 0%, #74C69D 100%)' },
]

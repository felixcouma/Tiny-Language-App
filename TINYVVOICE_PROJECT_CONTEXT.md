...
<!-- AUTO:START -->
> _Auto-updated on commit — last refreshed **2026-08-20 21:31 UTC** on branch `main`._
...
- `12f66ea Docs: bring all reference docs current (Phase 2 A–D, premium images, perf, guards)`
<!-- AUTO:END -->
